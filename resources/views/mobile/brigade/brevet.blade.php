...
@section('content')
    ...
    <div class="m-row-striped text-left">
        ...
        <div class="details" id="details1">
            <h4>Art. 4.1 Kledingeisen Kleding eisen voor de recreatieve diploma lijn tot en met junior redder 4</h4>

            <p>
                Badkleding
                T-shirt, blouse of hemd met mouwen – Lange broek (lange broeken die naadloos aansluiten op de huid zijn niet toegestaan)
                ...
                Het is toegestaan dat kandidaten i.p.v. broek/blouse een jurk met mouwen of rok/blouse met mouwen dragen. De jurk/ rok moet tot over de knie reiken.
                ...
                Brillen om de ogen te beschermen tegen direct contact met het zwemwater, zoals duikbrillen zijn op geen enkel examenonderdeel toegestaan (met uitzondering van de onderdelen waar wordt gesproken over geblindeerde bril (tempered glass).
                Duikbrillen (tempered glass), waarbij klaren mogelijk is, zijn alleen toegestaan op basis van medische indicatie en een toegekend schriftelijk dispensatie (zie artikel 1.4) en zijn geheel voor eigen risico.
            </p>
            <h4>
                Kleding eisen voor de recreatieve diploma lijn zwemmend redder 1 tot en met Life Saver 3
            </h4>
            <p>
                Badkleding
                T-shirt, blouse of hemd met mouwen – Lange broek (lange broeken die naadloos aansluiten op de huid zijn niet toegestaan)
